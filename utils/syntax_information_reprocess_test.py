...
if len(sys.argv)==6:
    tag_list=open( sys.argv[5],'r').readlines()
        ...
        with Pool(num_workers) as pool:
            if mode == "dpd":
                ...
                with open(input_file, 'r') as f_in:
                    ...
                    for mat in pool.imap(convert_conll_to_nparray, tqdm(zip(conll_chunks, swm_list,tag_list)), chunksize=256):
                        res.append(mat)
