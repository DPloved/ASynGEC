...
class SyntaxEnhancedTranslationTask(TranslationTask):
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths,src_tag_dataset=None, src_nt=None, src_nt_sizes=None, src_conll_dataset=None, src_dpd_dataset=None, src_probs_dataset=None, constraints=None, syntax_type=None):
        return SyntaxEnhancedLanguagePairDataset(
            src_tokens,
            src_lengths,
